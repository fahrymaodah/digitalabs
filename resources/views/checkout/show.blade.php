<x-layouts.public :title="'Checkout - ' . $course->title">
    ...
    <section class="bg-gradient-to-r from-orange-500 to-orange-600">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <nav class="flex items-center space-x-2 text-sm text-orange-100 mb-2">
                <a href="{{ url('/') }}" class="hover:text-white transition">Home</a>
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                </svg>
                <a href="{{ url('/courses/' . $course->slug) }}" class="hover:text-white transition">{{ Str::limit($course->title, 30) }}</a>
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                </svg>
            ...
            <div class="grid lg:grid-cols-5 gap-8">
                ...
                <div class="lg:col-span-3">
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <form action="{{ route('checkout.process', $course->uuid) }}" method="POST" id="checkout-form" class="p-6">
                            @csrf
                            ...
                            <div class="mb-8">
                                ...
                                <div class="flex gap-2">
                                    <input 
                                        ...
                                        name="coupon_code" 
                                        id="coupon_code"
                                        class="flex-1 rounded-xl border-gray-200 shadow-sm focus:border-orange-500 focus:ring-orange-500 px-4 py-3 border text-sm"
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex gap-4 mb-6">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">{{ $course->instructor->name ?? 'Digitalabs' }}</p>
                                    @if($course->category)
                            ...
                            <button 
                                type="submit" 
                                form="checkout-form"
                                class="w-full mt-6 py-4 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold rounded-xl transition shadow-lg shadow-orange-500/25 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
